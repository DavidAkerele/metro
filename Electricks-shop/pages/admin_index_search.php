                ...
                <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="typography-line">
                            <p>
                            “The reason it seems that price is all your customers care about is that you haven’t given them anything else to care about.”<br>-Seth Godin, <br>American author, entrepreneur, marketer, and public speaker.
                            </p>
                        </div>
                        <br>
                        ...
                        <ul class="thumbnails">
                            ...
                            <div class="row-sm-3">
                                ...
                                <div class="caption">
                                  ...
                                  <h6><a class="btn btn-success btn-round" title="Click for more details!" href="admin_product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">N<?php echo $res['prod_price']; ?></medium></h6>
                                </div>
